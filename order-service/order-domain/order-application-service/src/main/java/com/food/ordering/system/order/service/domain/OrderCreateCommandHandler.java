...
import com.food.ordering.system.order.service.domain.dto.OrderDomainService;
import com.food.ordering.system.order.service.domain.dto.create.CreateOrderCommand;
import com.food.ordering.system.order.service.domain.dto.create.CreateOrderResponse;
import com.food.ordering.system.order.service.domain.dto.entity.Customer;
...
public class OrderCreateCommandHandler {
    ...
    private Order saveOrder(Order order)
    {
        ...
        if(orderResult==null)
        {
            log.error("Not able to save the order");
            throw new OrderDomainException("Unable to Save");
        }
