...
import com.food.ordering.system.order.service.domain.dto.entity.OrderItem;
...
import com.food.ordering.system.order.service.domain.dto.valueobject.StreetAddress;
...
public class OrderDataMapper {
   ...
   public Restaurant createOrderCommandToRestaurant(CreateOrderCommand createOrderCommand){
    ...
    {
        return CreateOrderResponse.builder().orderTrackingId(
    ...
    return orderItems.stream().map(
            orderItem -> OrderItem.builder().product(new Product(new ProductId(orderItem.getProductId())))
    ...
    private StreetAddress orderAddressToStreetAddress(OrderAddress orderAddress) {
       return new StreetAddress(UUID.randomUUID(),
               orderAddress.getStreet(),orderAddress.getPostalCode(),orderAddress.getCity());
    }
